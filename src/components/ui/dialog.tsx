    ...
    <DialogPortal>
      ...
      >
        <motion.div
          ...
          className={cn('fixed left-1/2 top-1/2 z-50 w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-scheme-border/70 bg-scheme-surface p-6 shadow-2xl focus:outline-none', className)}
        >
          {children}
        </motion.div>
      </DialogPrimitive.Content>
